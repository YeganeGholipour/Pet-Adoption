...
urlpatterns = [
    ...
    path('register_an_adopter/', views.RegisterAnAdopter.as_view(), name='register-an-adopter'),
    ...
    path('update_adoption_status/<int:pk>/', views.UpdateAdoptionStatusView.as_view(), name='update-adoption-status'),
